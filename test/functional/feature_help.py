...
"""Verify that starting clipcoin with -h works as expected."""
import subprocess
...
class HelpTest(BitcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start clipcoin with -h for help text")
        ...
        self.log.info("Start clipcoin with -version for version information")
