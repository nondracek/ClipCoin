...
const char * const BITCOIN_CONF_FILENAME = "clipcoin.conf";
const char * const BITCOIN_PID_FILENAME = "clipcoind.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Clipcoin";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Clipcoin";
#else
    // Unix
    return pathRet / ".clipcoin";
#endif
#endif
}
