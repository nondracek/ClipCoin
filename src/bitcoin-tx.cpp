...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s clipcoin-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  clipcoin-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded clipcoin transaction") + "\n" +
              "  clipcoin-tx [options] -create [commands]   " + _("Create hex-encoded clipcoin transaction") + "\n" +
              "\n";
