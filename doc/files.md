...
* clipcoin.conf: contains configuration settings for clipcoind or clipcoin-qt
* clipcoind.pid: stores the process id of clipcoind while running
...
* debug.log: contains debug information and general logging generated by clipcoind or clipcoin-qt
