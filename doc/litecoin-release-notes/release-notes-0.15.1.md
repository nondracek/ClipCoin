...
The minimum relay fee `-minrelayfee` has been lowered to 0.01 cuts per kB (0.00001 CLP). This is to prepare for dropping the minimum transaction fee to 0.1 cuts per kB (0.0001 CLP) in the next release.
